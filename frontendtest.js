...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/Users/David/frontend-test/node_modules/react-hot-loader/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/Users/David/frontend-test/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	  ...
	  _createClass(Container, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(_ContentAreaContentArea2['default'], null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RegionBarRegionBar = __webpack_require__(168);
	  ...
	  _createClass(ContentArea, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(_SearchBarSearchBar2['default'], null),
	        _react2['default'].createElement(_RegionBarRegionBar2['default'], { isTitle: true, source: data, canExpand: true }),
	        _react2['default'].createElement(_RegionBarRegionBar2['default'], { source: data, canExpand: true }),
	        _react2['default'].createElement(_RegionBarRegionBar2['default'], { source: data, canExpand: false }),
	        _react2['default'].createElement(_RegionBarRegionBar2['default'], { source: data, areaLevel: 1, canExpand: false }),
	        _react2['default'].createElement(_RegionBarRegionBar2['default'], { source: data, areaLevel: 2, canExpand: false }),
	        _react2['default'].createElement(_RegionBarRegionBar2['default'], { source: data, areaLevel: 2, canExpand: false }),
	        _react2['default'].createElement(_RegionBarRegionBar2['default'], { source: data, canExpand: false }),
	        _react2['default'].createElement(_RegionBarRegionBar2['default'], { source: data, areaLevel: 1, canExpand: true }),
	        _react2['default'].createElement(_RegionBarRegionBar2['default'], { source: data, canExpand: false })
	      );
	    }
	  }]);
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/David/frontend-test/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "ContentArea.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement('button', { className: 'fa fa-sort-desc DropMenuIcon' })
	        ),
	        _react2['default'].createElement('input', { className: 'SearchBarTextInput', type: 'text',
	          placeholder: 'Search' }),
	        _react2['default'].createElement('button', { className: 'fa fa-search fa-lg serachButton' })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".VerticalAlign {\n  position: absolute;\n  top: 50%;\n  transform: translate(0%, -50%);\n  -ms-transform: translate(0%, -50%);\n  -webkit-transform: translate(0%, -50%); }\n\n.VerHorAlign {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  -ms-transform: translate(-50%, -50%);\n  -webkit-transform: translate(-50%, -50%); }\n\n.SearchBar {\n  height: 50px;\n  position: relative;\n  width: 100%;\n  font-size: 1.1em; }\n  .SearchBar .SearchBarDropMenu {\n    height: 100%;\n    float: left;\n    width: 140px;\n    border-right: 1px solid #abadb8; }\n    .SearchBar .SearchBarDropMenu .placeHolder {\n      display: inline-block;\n      color: #bac0cc;\n      position: absolute;\n      top: 50%;\n      left: 17px;\n      transform: translate(0%, -50%);\n      cursor: default; }\n    .SearchBar .SearchBarDropMenu .DropMenuIcon {\n      background-color: #fff;\n      position: absolute;\n      top: 50%;\n      left: 112px;\n      transform: translate(0%, -50%);\n      cursor: pointer; }\n  .SearchBar .SearchBarTextInput {\n    color: #bac0cc;\n    margin-left: 5px;\n    padding-left: 13px;\n    float: left;\n    border: 0;\n    width: 80%;\n    height: 50px; }\n  .SearchBar .serachButton {\n    background-color: #fff;\n    position: absolute;\n    right: 13px;\n    top: 13.5px;\n    cursor: pointer; }\n    .SearchBar .serachButton:hover {\n      color: #3bbb8d; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RegionBar = (function (_React$Component) {
	  ...
	  _createClass(RegionBar, [{
	    key: 'render',
	    value: function render() {
	      var baseTitleAreaWidth = 365; //365
	      var indent = 30;
	      var resultTitleAreaWidth = baseTitleAreaWidth - indent * this.props.areaLevel;
	      var expandText = this.props.areaLevel === 0 ? 'District' : 'Township';
	      ...
	      if (this.props.isTitle === true) {
	        return _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'div',
	            { className: 'RegionBarTitleArea', style: { width: 365 } },
	            _react2['default'].createElement(
	              'p',
	              { className: 'tilte' },
	              'Region'
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'p',
	            null,
	            this.props.source.votersCounts
	          )
	        ),
	        _react2['default'].createElement(
	          'div',
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/David/frontend-test/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "RegionBar.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
